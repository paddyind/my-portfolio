        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 mx-auto">
              ...
              {imageError ? (
                <div className="relative w-full h-full rounded-full shadow-2xl border-4 border-white bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
                  <span className="text-5xl md:text-6xl font-bold text-white">PV</span>
                </div>
              ) : (
                <img
                  src="/profile.jpg"
